...
void morskoiboi()
{
    ...
    while (true) {
        ...
        case '1':
            break;
        case '2': {
            cout << "После запуска, перед вами открывается игровое поле 10 на 10. Далее вы выбираете координаты местоположения ваших кораблей (Буква и Цифра слитно выбранной клетки) а именно:4х палубные корабли в количестве 1ой штуки , 3х палубные корабли в количестве 2х штук , 2х палубные корабли в количестве 3х штук , 1 палубные корабли в количестве 4х штук. После расставления кораблей вам будут выданы попытки стрельбы по кораблям противника(бота) , которые он ставил в случайном порядке. Когда вы попадаете на игровом поле противника показывается X , если промахиваетесь О. Если какая-то из сторон разрушила все корабли, игра завершается , а в консоли пишется результат матча." << endl;
            break; }
        default: {
